 ...
 *
 * 説明のうしろに全角スペースで一拍おいて、短い一言を足してある（2026-08-16 の判断）。
 ...
 *
 * 🔴 **技（`skills.js`）には持ち込まない。真面目なままにする**（2026-08-16 の判断）。
 * 技名は効き目の数字と並んで画面に出るので、ここをくずすと数字が読みにくくなる。
 * 冗談を置く場所は**実績の説明**と**装備の名前**（`dungeon.js`）の 2 つだけ。
 */
