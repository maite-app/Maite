...
export const SKILL_POWER = {
  ...
  // **0.06 では夜の寄与が +28pt で、線（+25pt 未満）を超えていた**（2026-08-16 実測）。
  // 0.05 は +24pt で通るが、測るたびに 1σ で跨ぐ位置。0.04 まで下げて +20pt
  // ── 不屈★3 と同着で、夜にしか乗らないぶん平均では不屈より弱い。
  nightVision: { perTier: 0.04 },
  // 振り払える弱体の回数＝段位そのもの
  mnemonic: { perTier: 1 },
};
